...
class FollowingViewModel : ViewModel() {
    ...
    private val listFollowingNonMutable = ArrayList<User>()
    private val listFollowingMutable = MutableLiveData<ArrayList<User>>()
    ...
    fun getDataGit(context: Context, id: String) {
        ...
        httpClient.addHeader("Authorization", "token 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")
